...
const defaultSignIn =
  "inline-flex min-h-10 items-center rounded-md bg-action px-3 py-2 font-semibold text-white hover:bg-action-dark focus:outline-none focus:ring-4 focus:ring-sky-300";
const defaultSignUp =
  "inline-flex min-h-10 items-center rounded-md border border-line px-3 py-2 font-semibold text-slate-800 hover:bg-sky-50 hover:text-action focus:outline-none focus:ring-4 focus:ring-sky-300";
 ...
 */
export function AccountControls({ signInClassName, signUpClassName, nameClassName }: AccountControlsProps) {
