...
export const posts = [
  {
    ...
    body: [
      ...
      "Tonight's AccessiWeather build is the next thing on deck. The plan is to keep pushing on the current notification and build-quality work, with special attention on the pieces that affect screen reader users directly: reliable status text, clear alerts, and fewer rough edges around daily weather workflows.",
